...
- Developers who want to understand configuration instead of copying commands
...
Read the documents in the order provided in the `docs/` directory.

Each file focuses on a single topic and assumes the previous steps are already completed.

This guide is written to be read carefully, not rushed.
